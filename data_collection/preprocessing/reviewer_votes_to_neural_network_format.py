...
def reviewer_votes_to_neural_network_format():
    reviewer_votes = json.load(
        open(common.path_relative_to_root("data_collection/raw_data/reviewer_vote_percentages_for_repos.json"), 'r'))
...
if __name__ == "__main__":
    logging.basicConfig(
        filename=common.path_relative_to_root("logs/reviewer_votes_to_percentages.log.txt"),
        level=logging.DEBUG
    )
